...
public class TheNurseJavaAngularLongMessage {
  public static void main(String[] args) throws Exception {

    ConfigurableApplicationContext context =
        SpringApplication.run(TheNurseJavaAngularLongMessage.class, args);
  ...
  public static class LongMessageListener {
    ...
    @KafkaListener(
        topics = "${long.message.topic.name}",
        groupId = "longMessage",
        containerFactory = "longMessageKafkaListenerContainerFactory")
