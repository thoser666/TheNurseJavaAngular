...
class TheNurseJavaAngularApplicationIntegrationTest {
  ...
  @Test
  public void givenDefaultPartitioner_whenSendingMessagesWithoutKey_shouldUseStickyDistribution()
  ...
  @Test
  public void givenProducerWithSameKeyMessages_whenSendingMessages_shouldReceiveInProducedOrder()
      throws InterruptedException {
  ...
  @Test
  public void givenCustomPartitioner_whenSendingMessages_shouldRouteToCorrectPartition()
      throws InterruptedException {
  ...
  @Test
  public void givenDirectPartitionAssignment_whenSendingMessages_shouldRouteToSpecifiedPartitions()
      throws Exception {
  ...
  @Test
  public void givenCustomPartitioner_whenSendingMessages_shouldConsumeOnlyFromSpecificPartition()
      throws InterruptedException {
    KafkaTemplate<String, String> kafkaTemplate = setProducerToUseCustomPartitioner();
